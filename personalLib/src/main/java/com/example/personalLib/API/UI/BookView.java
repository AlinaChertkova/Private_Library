...
public class BookView extends VerticalLayout implements HasUrlParameter<String> {
    ...
    public void setParameter(BeforeEvent event, String parameter) {
        ...
        isAuthorised = hasUserRole();

        Button link = new Button("Каталог");
        link.addClickListener(b ->  link.getUI().ifPresent(ui -> ui.navigate("")));
        links.add(link);
        ...
        {
            Button linkToLogin = new Button("Войти");
            linkToLogin.addClickListener(b ->  linkToLogin.getUI().ifPresent(ui -> ui.navigate("login")));
            links.add(linkToLogin);
        }
        ...
        add(links, coverLayout, buttons, genres, reviews);
